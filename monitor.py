...
def main():
    try:
        ...
        print(f'agoric,name=agoric_monitor status=1,{info_str}', '{:1.0f}'.format(time.time() * 1000000000))

    except:
        print(f'agoric,name=agoric_monitor status=0', '{:1.0f}'.format(time.time() * 1000000000))
